...
import com.demos.buddylocator.customlistview.friendslistview;
...
public class Friends extends AppCompatActivity {
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if(user!=null){
                    ...
                    Intent intent = new Intent(Friends.this,AuthActivity.class);
    ...
    public void setupNavigationBar(boolean checked){
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> arg0, View view, int arg2, long arg3) {
                ...
                if(arg2==0){
                    ...
                    Intent intent = new Intent(Friends.this,Request.class);
                    intent.putExtra("userdb",userdata);
                    intent.putExtra("userkey",userkey);
                    startActivity(intent);
        ...
        getSupportActionBar().setTitle(Html.fromHtml("<font color='#ffffff'>My Buddy</font>"));
    ...
    public void showDialogChaneName(final View view){
        ...
        buttonLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Friends.this, "Change Name Complete.", Toast.LENGTH_LONG).show();
                dialog.dismiss();
    ...
    public  void onUserdataUpdate(final Context context){
        ...
        mUserRef.child(userkey).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                friendslistview adapter = new friendslistview(context,userdata.getFriends(),userkey,userdata);
